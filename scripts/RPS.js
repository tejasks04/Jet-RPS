...
function stopAutoPlay(){
  const stopPlay = document.querySelector('.auto-play-button');
    if(auto) {
      stopPlay.innerHTML = 'Stop play';
      return auto = false;
    } if (!auto) {
      stopPlay.innerHTML = 'Auto Play';
     return auto = true;
    }
}
...
document.querySelector('.auto-play-button')
  ...
  function confirmResetAlert() {
    document.querySelector('.js-confirm')
    .innerHTML = `<p>Are you sure you want reset the score?
